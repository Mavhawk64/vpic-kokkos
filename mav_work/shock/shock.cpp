/*
 * Here is the beginning of a shock simulation.
 * So far, I have copied the code from /home1/mberkland2023/repos/vpic-kokkos/sample/harris
 * and added some additional parameters to begin converting it to a shock simulation.
 */
...
begin_initialization
{
    ...
    // TODO: SHOCK DEFINITION OF BOUNDARY CONDITIONS
    // Start with a wall at x = Lx
    // bunch up particles here
    // once certain amount of particles there,
    // remove wall and make boundary periodic at x = Lx

    // Search publications and see how they do it
    ...
    // name, charge, mass, max #particles, max #movers, sort_interval, sort_out_of_place
    ...
    sim_log("debyei = " << vthi / wpi << ", L/debyei = " << L / (vthi / wpi)
                        << ", dx/debyei = " << (Lx / nx) / (vthi / wpi));
    ...
    sim_log("debyee = " << vthe / wpe << ", L/debyee = " << L / (vthe / wpe)
                        << ", dx/debyee = " << (Lx / nx) / (vthe / wpe));
    ...
    ////////////////////////////////////////////////////
    // Pretty much everything below here is what will //
    // need to be changed for the shock simulation.   //
    ////////////////////////////////////////////////////
